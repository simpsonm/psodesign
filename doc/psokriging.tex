...
% if preview is on, generate a nopreview variable
% for generating eps files of figures
% this weird construction is needed so it works with \cprotect in Figures 3 and 4.
\ifPreview
\def\noprev{0}
\else
\def\noprev{1}
\fi 
\DeclareRobustCommand{\myprot}{\cite}
