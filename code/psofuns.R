...
## use a genetic algorithm to optimize objective function obj
## see: Finding Near-Optimal Bayesian Experimental Designs via Genetic Algorithms
##      M. Hamada, H. F. Martz, C. S. Reese and A. G. Wilson
##      The American Statistician
## for more details of each of these parameters
...
## warning: no input validation
## niter: number of iterations
## nswarm: size of the swarm, automatically set if < 1
...
## df: degrees of freedom of t kernel. df large (>30) is approximately a normal kernel
## ccc: tuning parameter c (only used if AT=TRUE)
## init: optional initial position of the swarm
## boundaryfun: optional function for moving particle to the nearest point on the boundary if it is outside of it
